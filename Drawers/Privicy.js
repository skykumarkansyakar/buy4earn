...
const Privicy=({navigation,route})=>  {
    ...
    return (
      <Container>
        ...
        <TouchableOpacity style={{flexDirection:'row'}}
          ...
          <Text style={{ color: 'white', fontWeight: 'bold', fontSize: RFPercentage(3), marginLeft: wp('2%') }}>Privacy Policy</Text>
          </TouchableOpacity>
          <StatusBar barStyle="dark-content" hidden={false} backgroundColor="#45CE30" />
        </Header>


        <WebView style={{ marginTop: 30 }} source={{ uri: 'https://www.buy4earn.com/privacy_policy' }} />
