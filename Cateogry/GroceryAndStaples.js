...
import { Text, StyleSheet, ActivityIndicator,BackHandler } from 'react-native';
...
export default class GroceryAndStaples extends Component {
  ...
  fetchData = async () => {
    ...
    var category = 'Grocery and Staples'
                        ...
                        >
                          <View style={{ margin: hp('1%'), margin: wp('1%'), justifyContent: 'center', alignItems: 'center', width: wp('27%') }}>
                            ...
                            <PlaceHolderImage
                              ...
                              // source={require('../assest/Image/dummy.jpg')}
